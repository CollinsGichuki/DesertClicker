...
//Class constructor takes a LifeCycle object that it uses tp observe
//Claas implements the LifecycleObserver interface
class DessertTimer(lifecycle: Lifecycle): LifecycleObserver {
    ...
    //Init
    init {
        //Connect the lifecycle object with the observer(the class)
        lifecycle.addObserver(this)
    }

    //All the LifeCycle events that the observer can observe are in the Lifecycle.Event class
    //Now the handler lifecycle is handled by the LifeCycle Library.
    //We don't explicitly call it in MainActivity's lifecycle callbacks
